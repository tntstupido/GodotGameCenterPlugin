...
void GameCenterPlugin::_bind_methods() {
	ClassDB::bind_method("sign_in", &GameCenterPlugin::sign_in);
	ClassDB::bind_method("signIn", &GameCenterPlugin::signIn);
	ClassDB::bind_method("refresh_auth_status", &GameCenterPlugin::refresh_auth_status);
	ClassDB::bind_method("refreshAuthStatus", &GameCenterPlugin::refreshAuthStatus);
	ClassDB::bind_method("is_signed_in", &GameCenterPlugin::is_signed_in);
	ClassDB::bind_method("isSignedIn", &GameCenterPlugin::isSignedIn);
	ClassDB::bind_method("is_cloud_available", &GameCenterPlugin::is_cloud_available);
	ClassDB::bind_method("isCloudAvailable", &GameCenterPlugin::isCloudAvailable);
	ClassDB::bind_method("get_player_id", &GameCenterPlugin::get_player_id);
	ClassDB::bind_method("getPlayerId", &GameCenterPlugin::getPlayerId);
	ClassDB::bind_method("get_player_display_name", &GameCenterPlugin::get_player_display_name);
	ClassDB::bind_method("getPlayerDisplayName", &GameCenterPlugin::getPlayerDisplayName);
	ClassDB::bind_method("submit_score", &GameCenterPlugin::submit_score);
	ClassDB::bind_method("submitScore", &GameCenterPlugin::submitScore);
	ClassDB::bind_method("load_game", &GameCenterPlugin::load_game);
	ClassDB::bind_method("loadGame", &GameCenterPlugin::loadGame);
	ClassDB::bind_method("save_game", &GameCenterPlugin::save_game, DEFVAL(""));
	ClassDB::bind_method("saveGame", &GameCenterPlugin::saveGame, DEFVAL(""));
	ClassDB::bind_method("delete_game", &GameCenterPlugin::delete_game);
	ClassDB::bind_method("deleteGame", &GameCenterPlugin::deleteGame);
	ClassDB::bind_method("delete_saved_game", &GameCenterPlugin::delete_saved_game);
	ClassDB::bind_method("deleteSavedGame", &GameCenterPlugin::deleteSavedGame);
	ClassDB::bind_method("load_top_scores", &GameCenterPlugin::load_top_scores, DEFVAL("all_time"), DEFVAL("public"), DEFVAL(10), DEFVAL(true));
	ClassDB::bind_method("loadTopScores", &GameCenterPlugin::loadTopScores, DEFVAL("all_time"), DEFVAL("public"), DEFVAL(10), DEFVAL(true));
	ClassDB::bind_method("load_player_score", &GameCenterPlugin::load_player_score, DEFVAL("all_time"), DEFVAL("public"), DEFVAL(true));
	ClassDB::bind_method("loadPlayerScore", &GameCenterPlugin::loadPlayerScore, DEFVAL("all_time"), DEFVAL("public"), DEFVAL(true));
